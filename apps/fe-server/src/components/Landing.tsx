            ...
            <section className="container mx-auto px-4 py-20 text-center relative overflow-hidden">
                ...
                <div className="relative">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                        Store, organize, and instantly find any piece of
                        information using our advanced AI-powered search. From
                        PDFs to images, BrainBase remembers everything so you
                        don not have to.
                    </p>
                    ...
                    <div className="relative max-w-3xl mx-auto p-8 rounded-xl border bg-card/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 group">
                        <div className="flex items-center gap-3 p-4 rounded-lg border bg-background/80">
                            ...
                            <span className="text-muted-foreground">
                                &quot;Find the marketing presentation from last
                                quarter that mentioned AI trends...&quot;
                            </span>
                        </div>
                ...
                <div className="relative rounded-3xl bg-gradient-to-r from-purple-600/10 to-blue-500/10 p-16 overflow-hidden gradient-animate">
                    <div className="relative z-10 text-center">
                        ...
                        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                            Join thousands of professionals who trust BrainBase
                            to manage their digital knowledge. Start your free
                            trial today.
                        </p>
                        <Button
                            size="lg"
